<?php include('partials-front/menu.php'); ?>
    ...
    <?php 
        //CHeck whether Car id is set or not
        if(isset($_GET['car_id']))
        {
            //Get the Car id and details of the selected car
            $car_id = $_GET['car_id'];

            //Get the Details of the Selected Car
            $sql = "SELECT * FROM tbl_car WHERE id=$car_id";
            //Execute the Query
            ...
            <div class="container">
                ...
                <form action="#" method="POST" class="order">
                    ...
                    <fieldset>
                        ...
                        <input type="email" name="email" placeholder="E.g. example@test.com" class="input-responsive" required>
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center'>Car Ordered Successfully.</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
                        //Failed to Save Order
                        $_SESSION['order'] = "<div class='error text-center'>Failed to Order Car.</div>";
                        header('location:'.SITEURL);
                    }
